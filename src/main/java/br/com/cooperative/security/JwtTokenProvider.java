package br.com.cooperative.security;

import br.com.cooperative.configs.CP;
import br.com.cooperative.exceptions.NotAuthorizateException;
...
public class JwtTokenProvider {
    ...
    private String secretKey = CP.SIGNATURE_KEY;
    ...
    public TokenReponse createAccessToken(String username, List<String> roles) {
        Date now = new Date();
        Date validity = new Date(now.getTime() + CP.EXPIRATION);
        var accessToken = getAccessToken(username, roles, now, validity);
        var refreshToken = getRefreshToken(username, roles, now);

        return new TokenReponse(username, true, now, validity, accessToken, refreshToken);
    }
